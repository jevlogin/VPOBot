namespace WORLDGAMEDEVELOPMENT
{
    internal static class DialogData
    {
        ...
        public const string PREPARING_FOR_THE_TRIP = "Для начала, давайте проверим вашу готовность к путешествию к здоровому образу жизни!\n\nЕсли вы готовы, давайте начнем!\n";
        public const string PREPARING_FOR_THE_TRIP_LOST_STEP = "Если вам нужно больше времени или вы хотите познакомиться анонимно, ничего страшного! " +
        ...
        public const string INTRODUCTORY_INFORMATION_ABOUT_THE_TRIP = "Перед тем, как начать наше приключение, давайте составим первичный дневник питания в течение 3 дней.\n\n";
        ...
        public static string[] USER_CONGRATILATORY_RESPONSES_ANSWER = new string[]
        {
            ...
            "Вы просто волшебник! Верьте в себя и ничего не остановит ваш путь!",
