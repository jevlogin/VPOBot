namespace WORLDGAMEDEVELOPMENT
{
    internal static class DialogData
    {
        ...
        public const string HERBY_PROGRAM_PRESENTATION_RIDDLES = "У нас здесь много увлекательных головоломок и интересных задач, " +
                    "чтобы помочь вам обрести осознанное здоровье и энергию жизни, ЛЕГКО и непринуждённо.\r\n\r\nМы вызовем у Вас интерес к хорошему.";
        ...
        public const string VPO_PROGRAM_ZOOM = "Также, для участия в программе Вам может потребоваться установить приложение ZOOM, <b>сейчас это не обязательно</b>.\r\n\r\n" +
        ...
        public const string WHAT_IS_FOODDIARY_1 = "Все верно, я же еще не рассказал...\r\n\r\n" +
                        ...
                        "Его можно вызвать из специального пункта <b>Меню</b> -> <b>Дневник питания</b>";
